...
const jefes = [
    ...
    { nivel: 5, nombre: "Regice", clima: [1], cp_max: "1764", cp_max_clima: "2205"},
    ...
    { nivel: 4, nombre: "Golem", clima: [6, 4], cp_max: "1666", cp_max_clima: "2083"},
    { nivel: 4, nombre: "Houndoom", clima: [4, 0], cp_max: "1445", cp_max_clima: "1806"},
    { nivel: 4, nombre: "Lapras", clima: [1, 5], cp_max: "1487", cp_max_clima: "1859"},
    { nivel: 4, nombre: "Rhydon", clima: [6, 4], cp_max: "1886", cp_max_clima: "2357"},
    { nivel: 4, nombre: "Snorlax", clima: [6], cp_max: "1917", cp_max_clima: "2396"},
    ...
    { nivel: 3, nombre: "Aerodactyl", clima: [5, 3], cp_max: "1490", cp_max_clima: "1863"},
    { nivel: 3, nombre: "Alakazam", clima: [3], cp_max: "1649", cp_max_clima: "2062"},
    ...
    { nivel: 3, nombre: "Jolteon", clima: [5], cp_max: "1560", cp_max_clima: "1950"},
    { nivel: 3, nombre: "Kabutops", clima: [5, 6], cp_max: "1438", cp_max_clima: "1798"},
    { nivel: 3, nombre: "Machamp", clima: [2], cp_max: "1650", cp_max_clima: "2063"},
    { nivel: 3, nombre: "Omastar", clima: [5, 6], cp_max: "1534", cp_max_clima: "1918"},
    { nivel: 3, nombre: "Onyx", clima: [6, 4], cp_max: "572", cp_max_clima: "715"},
    ...
    { nivel: 3, nombre: "Scyther", clima: [5, 6], cp_max: "1408", cp_max_clima: "1760"},
    { nivel: 2, nombre: "Huevo nivel 2"},
    //{ nivel: 2, nombre: "Muk", clima: [3, 4], cp_max: "1666", cp_max_clima: "2083"},
